...
//-----> YOUR CODE HERE
      countUniqueWords(uniqueWords, countWords, txt);
      
      // print out number of unique words found, like: "Number of unique words: 23"
//-----> YOUR CODE HERE
      System.out.println("Number of unique word: " + countWords.size());
...
//-----> YOUR CODE HERE
      for (int i = 0; i < uniqueWords.size(); i++) {
        System.out.print(countWords.get(i) + "\t" + uniqueWords.get(i));
        System.out.println();
      }
...
//-----> YOUR CODE HERE
      ...
      for (int i = 0; i < wordList.size() - 1; i ++ ) {
        if (wordList.get(i).compareTo(wordList.get(i+1)) > 0) {
          smallString = wordList.get(i);
          wordList.set(i, wordList.get(i + 1));
          wordList.set(i + 1, smallString);
